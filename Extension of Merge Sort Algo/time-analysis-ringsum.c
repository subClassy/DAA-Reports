...
{
	FILE *fp1, *fp2;
	fp1 = fopen("best-case-intersection.txt","w");
	fp2 = fopen("worst-case-intersection.txt","w");
			
	printf("Performing best case for intersection of sets\n");
	    for(int i=1;i<=199;i++)
	    {
		    for(int j=1;j<=i;j++)
		    {
	    ...
	    printf("Performing worst case for intersection of sets\n");
	    for(int i=1;i<=100;i++)
	    {
		    for(int j=1;j<=i;j++)
		    {
